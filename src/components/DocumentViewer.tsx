...
// Using a specific stable version of pdfjs-dist from Cloudflare CDN for better reliability.
pdfjs.GlobalWorkerOptions.workerSrc = `https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.17/pdf.worker.min.js`;
